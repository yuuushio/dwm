...
static const int systraylpad   			 = 0;   /* systray horizontal padding */
static const unsigned int systrayspacing = 5;   /* systray spacing */
static const int showsystray             = 1;   /* 0 means no systray */
#endif // BAR_SYSTRAY_PATCH

#if BAR_COLORFULTAGS_PATCH
static const unsigned int colorseltag    = 1;   /* 0 means use SchemeSel for selected tag */
...
#else
static const char *fonts[]               = { "JetBrainsMono Nerd Font:pixelsize=13:antialias=true:autohint=true", "JetBrainsMono Nerd Font:pixelsize=13:antialias=true:autohint=true" };
#endif // BAR_PANGO_PATCH
#if !NODMENU_PATCH
static const char dmenufont[]            = "JetBrainsMono Nerd Font:pixelsize=13:antialias=true:autohint=true";
#endif

#if BAR_ALPHA_PATCH
const unsigned int baralpha = 0.92 * OPAQUE;
...
const unsigned int alphas[][3] = {
	...
	[SchemeTitleSel]     = { OPAQUE, baralpha * 0.9 , borderalpha },
...
static char normfgcolor[]                = "#585b70";
...
static char tagsnormfgcolor[]            = "#313244";
static char tagsnormbgcolor[]            = "#181825";
static char tagsnormbordercolor[]        = "#444444";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#f5c2e7";
...
#if BAR_COLORFULTAGS_PATCH
static char tag1fgcolor[]                = "#b4befe";
static char tag2fgcolor[]                = "#b4befe";
static char tag3fgcolor[]                = "#b4befe";
static char tag4fgcolor[]                = "#b4befe";
static char tag5fgcolor[]                = "#b4befe";
static char tag6fgcolor[]                = "#b4befe";
static char tag7fgcolor[]                = "#b4befe";
static char tag8fgcolor[]                = "#b4befe";
static char tag9fgcolor[]                = "#b4befe";

static char tag1bgcolor[]                = "#181825";
static char tag2bgcolor[]                = "#181825";
static char tag3bgcolor[]                = "#181825";
static char tag4bgcolor[]                = "#181825";
static char tag5bgcolor[]                = "#181825";
static char tag6bgcolor[]                = "#181825";
static char tag7bgcolor[]                = "#181825";
static char tag8bgcolor[]                = "#181825";
static char tag9bgcolor[]                = "#181825";

static char layoutfgcolor[]				 = "#89b4fa";
static char layoutbgcolor[]				 = "#181825";
#endif
...
static const Rule rules[] = {
	...
	RULE(.class = "Code", .tags = TAG(3), .noswallow = 1)
	RULE(.class = "discord", .tags = TAG(2))
	RULE(.class = "discord", .wintype = WTYPE "DIALOG", .isfloating = 1, .iscentered = 1)
};
...
#define PAMIXER(cmd) SHCMD("pamixer " cmd "; pkill -RTMIN+22 dwmblocks")
#define scrotPath "~/Pictures/Screenshots/$(date '+%Y-%m-%d_%H.%M.%S').png"
static Key keys[] = {
	/* modifier                     key            function                argument */
	...
	{ MODKEY|ControlMask,                       XK_m,          togglegaps,             {0} },
	...
	#if STICKY_PATCH
	{ MODKEY|ControlMask,                       XK_period,          togglesticky,           {0} },
	#endif // STICKY_PATCH
    ...
    { MODKEY,                       XK_s,            spawn,                  SHCMD("~/.local/mouse_sens") }, /* Mouse sensitivity */
	{ MODKEY|ControlMask,           XK_s,            spawn,                  SHCMD("~/.local/swap_capslock") },
    ...
    { MODKEY|ControlMask,                       XK_backslash,    spawn,                  SHCMD("lf") },
	{ MODKEY,           XK_backslash,    spawn,                  SHCMD("thunar") },
    { MODKEY,                       XK_slash,        spawn,                  SHCMD("~/.dwm/rl_jar.sh") },
	//{ MODKEY|ShiftMask,             XK_w,          spawn,                  SHCMD("st -e nmtui") },
	//{ MODKEY,                       XK_e,          spawn,                  SHCMD("st -e tmux new-session nnn -a -P p") },
	...
	//{ MODKEY, XK_F4, spawn, SHCMD("st -e pulsemixer; pkill -RTMIN+22 dwmblocks") },
...
static Button buttons[] = {
	...
	#if BAR_STATUSBUTTON_PATCH && !NODMENU_PATCH
